            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.files') }}" wire:navigate>Home</a></li>
                ...
                <div class="col-sm-10 offset-1">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Редактировать Файл</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                            <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input @error('file') is-invalid @enderror" id="image" wire:model.blur="newFile">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @if ($newFile)
                                            <p class="text-green text-bold">{{ $newFile->getClientOriginalName() }}</p>
                                        @else
                                            <p class="text-danger">{{ $filename }}</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-check ml-3">
                                            <input type="checkbox" class="form-check-input" id="published" wire:model="published" @if($published) checked @endif>
                            ...
                            <div class="card-footer">
                                <a type="submit" class="btn btn-secondary mr-3" href="{{ route('admin.files') }}" wire:navigate>Отменить</a>
