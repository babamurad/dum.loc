                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="card-title">Список Наши файлы</h3>
                                    <a class="btn btn-sm btn-success ml-5" href="{{ route('admin.files.create') }}"
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($files as $file)
                                    <tr>
                                        <td>{{ $file->id }}</td>
                                        <td>
                                            <a href="{{ route('admin.files.edit', ['id' => $file->id]) }}" wire:navigate>{{$file->title}}</a>
                                        </td>
                                        <td class="w-25">
