    ...
    <div class="container">
        ...
        <section id="about">
            <h2 id="sectionAbout"
                ...
                компании</h2>
            <p class="text-center">
                <strong>ХО Довребап улаг меркези <span role="button">(ХО ДУМ)</span> </strong> — транспортно-логистическая компания, резидент -
            ...
            <div class="row">
                ...
                <div class="col-md-9 wow animated fadeInRight">
                    <p class="text-justify"> Создана 7 мая 2016 года и специализируется на жд перевозках.<br>
                        ...
                        создания успешного бизнеса, работающего на долгосрочную перспективу.

                        Основными направлениями нашей деятельности являются транспортировка и комплексное экспедиторское
                        обслуживание
                        экспортно-импортных и транзитных грузов железнодорожным
                       и прочими видами транспорта по
                        территории Туркменистана и всех стран СНГ, стран Балтии, Афганистана и др.
                        <a class="content_toggle" href="#"> Подробнее...</a>
                        <div class="content_block text-justify" style="display: none;">Производится непрерывный контроль за всеми этапами перевозки
                        (погрузка, охрана груза, слежение за подвижным составом, обеспечение выгрузки на станциях, в портах и на терминалах и своевременный возврат
                        порожнего вагона).
                        ...
                        <p>
                            В 2019 году ХО ДУМ осуществил поставку по железной дороге 80% труб для
                            строительства газопровода ТАПИ , берущего свое
                            начало от самого крупного газового месторождения Туркмении Галкыныш (Возрождение), около
                            1814 километров.

                        </p>
                        <p>
                            В 2020 - 2021 годах была большая партия поставки гуманитарной помощи в Афганистан муки и пшеницы.
                        </p>
                        <p>
                            В 2022 году мы осуществляли перевозку 50% бензина через Галабу эксп на Хайратон, и были на ряду с национальными компаниями Узбекистана.
                        </p>
                        <p>
                            В 2023 годах были осуществлены тестовые поставки бензина через Туркменистан в Афганистан, Иран и успешно завершены. Были перевозки пиломатериалов в Туркменистан,  Узбекистан и другие..
                        </p>

                            Также в 2023-2024 году 100% перевозок сахара -сырца через Туркменистан в Узбекистан..
                        <p>
                            Проектов было отработано не мало, и каждый был достойно отработан. Слаженная работа компании позволила нам
                            держаться в лидерах и занимать первые места 3 года подряд с 2021-2023 гг.
                        </p>
                    </div>
