<div>
    <div class="container">
        ...
        <h2 id="sectionAbout" class="h2-responsive mt-5 mb-3 h3 text-center about text-uppercase wow animated fadeInDown">О компании</h2>
        <p class="text-center">
            <strong>ХО Довребап улаг меркези (ХО ДУМ)</strong> — транспортно-логистическая компания, резидент -  объявленный экспедитор Туркменистана.
        </p>
        <!--Row About-->
        <div class="row">
            <div class="col-md-3 wow animated fadeInLeft"><img class="img-fluid" src="img/about-us2.jpg" alt="about-us"></div>
            <div class="col-md-9 wow animated fadeInRight">
                <p class="text-justify"> Создана 7 мая 2016 года и специализируется на жд перевозках.<br>
                    ...
                    создания успешного бизнеса, работающего на долгосрочную перспективу.<a class="content_toggle" href="#">
                        Подробнее...</a>
                <div class="content_block text-justify" style="display: none;">
                    Основными направлениями нашей деятельности являются транспортировка и комплексное экспедиторское обслуживание
                    экспортно-импортных и транзитных грузов железнодорожным и прочими видами транспорта по территориям стран СНГ,
                    стран Балтии, Афганистана и др. Производится непрерывный контроль за всеми этапами перевозки (погрузка, охрана
                    груза, слежение за подвижным
                    составом, обеспечение выгрузки на станциях, в портах и на терминалах и своевременный возврат порожнего вагона).
                    <br><strong>Коммуникабельность и мобильность</strong> позволяют нам непрерывно работать над снижением
                    себестоимости перевозки и предлагать клиентам максимально приемлемые тарифы на транспортные услуги.<br>
                    <strong>ХО ДУМ</strong> нацелена на привлечения объёмов за счет гибкости цен, качественного сервиса и индивидуального подхода к
                    каждому партнеру.
                    <h5 class="mt-2">Интересные факты</h5>
                    <p>
                        В 2019 году <strong>ХО ДУМ</strong> осуществил поставку по железной дороге 80% труб для строительства газопровода <strong>ТАПИ</strong> , берущего свое
                        начало от самого крупного газового месторождения Туркмении Галкыныш (Возрождение), около 1814 километров.
        ...
        <!-- /Grid column -->
        <h2 id="sectionAbout" class="h2-responsive my-5 h3 text-center about text-uppercase animated fadeInDown">Наши преимущества</h2>
        <div class="row features-small mb-5 mt-3">
            ...
            <div class="col-md-4 flex-center wow animated fadeInUp">
                <img src="img/our_files.JPEG" alt="MDB Magazine Template displayed on iPhone" class="z-depth-0 img-fluid">
            </div>
            <!--/Second column-->
            <!--Third column-->
        ...
        <section id="mission" class="mt-5 wow fadeIn text-center text-uppercase">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 mb-4 wow animated fadeInLeft" data-wow-delay="0.2s">
                    ...
                    <img src="img/mission.jpg" class="img-fluid z-depth-1-half" alt="mission">
                ...
                <div class="col-md-6 mb-4 wow animated fadeInRight" data-wow-delay="0.2s">
                    ...
                    <p class="text-left"> <strong>ХО ДУМ</strong> – один из немногих национальных операторов Туркменистана, оказывающих услуги в Казахстане,
                    ...
                    <ul>
                        ...
                        <li class="text-left">быть эффективным партнером и поставщиком услуг в сфере грузовых железнодорожных перевозок</li>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 mb-4 wow animated fadeInLeft" data-wow-delay="0.2s">
                    ...
                    <p class="text-right"> Мы гордимся каждым <strong>нашим клиентом</strong> и мы делаем все для того, чтобы они получили самые лучшие и качественные
                    ...
                    <p class="text-right">
                        ...
                        <strong>Финансовая стабильность</strong> – это гарантия устойчивости нашего бизнеса в любых экономических реалиях,

                        а ее диверсифицированность страхует нас от рисков резких рыночных колебаний и негативных тенденций в отдельных
                    ...
                    <p class="text-right">
                        ...
                        <strong>Командная работа</strong> является базовой ценностью обеспечивающий развитие и прозрачность бизнеса.
    ...
    <!--Section Zayawka-->
    <section id="rascet" class="bg-black py-4">
        <div class="container">
            <h2 class="about white-text text-center text-uppercase mb-0 pb-4 wow fadeInUp" data-wow-delay="0.2s">Расчет ставок </h2>
            <div class="row">
                <div class="col-md-4 white-text text-center align-content-center wow animated fadeInLeft">
                    <div class="align-content-center mt-5">
                        ...
                        <img src="img/pexels-frans-van-heerden-1624695.jpg" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-8 white-text text-center wow animated fadeInRight">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    <div class="col-ms-12">
                                        ...
                                        <input type="text" class="form-control" id="name_of_comp" name="name_of_comp" placeholder="ООО Победа" required>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="railcar_owner" name="railcar_owner" placeholder="СПС/МПС">
                                </fieldset>
                                <fieldset class="form-group">
                                    <label for="depart_station">Станция отправления</label>
                                    <input type="text" class="form-control" id="depart_station" name="depart_station" placeholder="Костанай станция">
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="destin_station" name="destin_station" placeholder="Серхетабат эксп">
                                </fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ter_exp" name="ter_exp" placeholder="Казахстан, Туркменистан">
                                </fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cargo_name" name="cargo_name" placeholder="Пшеница">
                                </fieldset>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cargo_code" name="cargo_code" placeholder="ГНГ10019000 / ЕТСНГ011005">
                                </fieldset>
                            </div>
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    <label for="cargo">Вес (тн)</label>
                                    <input type="text" class="form-control" id="cargo_weight" name="cargo_weight" placeholder="70 тн">
                                </fieldset>
                            </div>
                        </div>
    ...
    <section class="blue-gradient">
        <div class="container mt-5">
            ...
            <div class="row  pb-4">
                ...
                <div class="col-md-6 white-text justify-content-lg-center align-content-center wow animated fadeInRight" data-wow-delay="0.2s">
                    ...
                    <ul style="line-height: 2.8rem;">
                        ...
                        <li>
                            <a class="ourfl" href="img/2)Условия 2021 на 2 кв ТРК УТИ ТДЖ КРГ.pdf" target="_blank">Условия на 2 квартал 2021 г.</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/3)Ставки пор 2 кв 2021г.jpg" target="_blank">Ставки на порожний возврат вагонов 2 квартал 2021 г.</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/4)Порядок организации возврата порожнего вагона.pdf" target="_blank">Порядок оформления порожних вагонов</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/map.webp" target="_blank">Карта железной дороги Туркменистана</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/5) Погранпереходы Туркменистан-СНГ.pdf" target="_blank">Погранстыки Туркменистан-СНГ и др</a>
                        </li>
                    </ul>
            ...
            <hr>
            <h3 class="h3 pb-3 text-center white-text wow animated fadeInDown about" data-wow-delay="0.2s">Заключение договора</h3>
            <div class="row pb-3">
                <div class="col-md-6 white-text justify-content-lg-center align-content-center wow animated fadeInLeft" data-wow-delay="0.2s">
                    <ul style="line-height: 2.8rem;">
                        <li>
                            <a class="ourfl" href="img/Sertificate.jpg" target="_blank">Регистрационный сертификат ХО ДУМ</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/ЕГРПО продл 2021_compressed.pdf" target="_blank">ЕГРПО</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/Tax_code.jpg" target="_blank">Свидетельство о постановке на налоговый учет</a>
                        </li>
                        <li>
                            <a class="ourfl" href="img/Запрос доков на закл дог-ра Юр лиц (1).pdf">Запрос пакета документов заказчика</a>
                        </li>
                        <li>
                    ...
                    <div class="row text-center" style="line-height: 4rem;">
                        ...
                        <div class="col-sm-12">
                            ...
                            <a href="cart.html#kartocka"
                               class="btn btn-white btn-rounded blue-text font-weight-bold ml-lg-0 wow fadeIn waves-effect waves-light"
                               data-wow-delay="0.3s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.3s;">
                                Просмотр
                            </a>
                        </div>
                        <div class="col-sm-12">
                            <a href="Карточка компании – ХО «Довребап улаг меркези».xls" download="Карточка компании.xls"
    ...
    <div class="streak streak-photo" style="background-image:url('img/daniel-hazra-O96jiuCQht0-unsplash.jpg'); height: 3%;">
            ...
            <div class="container">
                ...
                <div class="row text-white  wow fadeInDownBig" data-wow-delay="0.2s">
                    <div class="col-md-12 text-center">
                        <br>
                        <h2 class="text-center my-5 py-5" style="line-height: 3rem;">Дорог железных паутина<br>Легла на сотни тысяч вёрст.<br>Сложи все рельсы воедино -<br>Домчаться сможешь <br>и до звёзд!</h2>
                        <br>
                    </div>
    ...
    <div class="container">
        ...
        <h2 id="contacts" class="h2-responsive text-center font-weight-bold text-center my-4 pt-4 about text-uppercase">Свяжитесь с нами</h2>
            ...
            <div class="col-md-9 mb-md-0 mb-5 wow animated fadeInLeft">
                ...
                <form id="contact-form" action="" method="POST">
                    ...
                    <div class="text-center text-md-left">
                        <button class="btn btn-rounded btn-orange-2 white-text btn-send" type="submit">Отправить</button>
                    </div>
            ...
            <div class="col-md-4 col-lg-3 wow animated fadeInRight">
                ...
                <ul class="text-center list-unstyled float-md-right">
                    ...
                    <li>
                        ...
                        <p><a href="tel: +99312468772">(99312) 46-87-72</a></p>
                        <p>Телефон руководства:</p>
                        <p><a href="tel: +99312468739"> (99312) 46-87-39</a></p>
                    </li>
